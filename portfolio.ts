...
export const greetings: GreetingsType = {
    ...
    resumeLink: 'https://drive.google.com/file/d/1OIxZnRDZIYsueqFDq1LtQtVEl26l3fUQ/view?usp=sharing',
};
...
export const experience: ExperienceType[] = [
    {
        ...
        company: 'PanelPlace',
        companyLogo: '/img/icons/common/PanelPlace.jpg',
    ...
    },
    {
        ...
        company: 'Guudjob',
        companyLogo: '/img/icons/common/Guudjob.png',
        ...
        descBullets: [
            ...
            `Effectively collaborated with the UX team to optimize the user experience, resulting in a 15% increase in customer satisfaction scores.`
        ],
    },
    {
        role: 'Junior Full-Stack Developer',
        company: 'Dash Living',
        companyLogo: '/img/icons/common/DashLiving.jpg',
...
export const seoData: SEODataType = {
    ...
    url: 'https://lee-portfolio-devmrwor.vercel.app',
    keywords: [
        'ZhuChong',
        'ZhuChong Lee',
        '@devmrwor',
